...
namespace FPIMusicClient.Core.ModelDTO
{
    ...
    public partial class DeezerExtendedArtiste
    {
        ...
        public static DeezerExtendedArtiste FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<DeezerExtendedArtiste>(data, new Newtonsoft.Json.JsonSerializerSettings());
