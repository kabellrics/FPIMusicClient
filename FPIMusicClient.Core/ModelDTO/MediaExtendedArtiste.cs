...
namespace FPIMusicClient.Core.ModelDTO
{
    ...
    public partial class MediaExtendedArtiste
    {
        ...
        public static MediaExtendedArtiste FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<MediaExtendedArtiste>(data, new Newtonsoft.Json.JsonSerializerSettings());
