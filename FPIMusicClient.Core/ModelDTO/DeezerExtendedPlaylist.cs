...
namespace FPIMusicClient.Core.ModelDTO
{
    ...
    public partial class DeezerExtendedPlaylist
    {
        ...
        public static DeezerExtendedPlaylist FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<DeezerExtendedPlaylist>(data, new Newtonsoft.Json.JsonSerializerSettings());
