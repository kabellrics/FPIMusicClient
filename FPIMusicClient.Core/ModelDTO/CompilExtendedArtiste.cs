...
namespace FPIMusicClient.Core.ModelDTO
{
    ...
    public partial class CompilExtendedArtiste
    {
        ...
        public static CompilExtendedArtiste FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<CompilExtendedArtiste>(data, new Newtonsoft.Json.JsonSerializerSettings());
