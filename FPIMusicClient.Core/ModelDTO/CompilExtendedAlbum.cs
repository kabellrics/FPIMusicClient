...
namespace FPIMusicClient.Core.ModelDTO
{
    ...
    public partial class CompilExtendedAlbum
    {
        ...
        public static CompilExtendedAlbum FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<CompilExtendedAlbum>(data, new Newtonsoft.Json.JsonSerializerSettings());
